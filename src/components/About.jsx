...
export default function About() {
  return (
    ...
    >
      ...
      <div className="sticky top-0 h-screen flex flex-col md:flex-row px-6 md:px-12 items-start justify-between text-gray-400">
        
        {/* Left: About Me heading + stacked skills */}
        <div className="flex-1 space-y-12 md:space-y-20">
          ...
          {skills.map((skill, idx) => (
            <div
              ...
              style={{ height: "200px" }} // Reserve vertical space for stacking
            >
              {/* Sticky Skill Name */}
              <h3
